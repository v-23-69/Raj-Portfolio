  ...
  return (
    ...
    >
      ...
      <div ref={ref} className="relative section-fade-in max-w-6xl mx-auto px-6">
        ...
        <div className="space-y-6 md:space-y-8 font-body text-charcoal-light leading-relaxed mb-8 md:mb-12">
          <p className="text-lg">
        ...
        <div className="bg-card rounded-sm p-6 md:p-10 border border-border">
